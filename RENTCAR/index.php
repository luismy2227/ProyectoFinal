				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-7 col-md-6 ">
							...
							<a href="#" class="primary-btn text-uppercase">RENTCAR</a>
						</div>
						<div class="col-lg-5  col-md-6 header-right">
							<h4 class="text-white pb-30">Libro de Carro de Hoy!</h4>
							<form class="form" role="form" autocomplete="off">
							    <div class="form-group">
							       	<div class="default-select" id="default-select"">
										<select>
											<option value="" disabled selected hidden>Seleccione Su Vehiculo</option>
							    ...
							    <div class="from-group">
							    	<input class="form-control txt-field" type="text" name="nombre" placeholder="Nombre">
							    	<input class="form-control txt-field" type="email" name="correo" placeholder="Correo">
							    	<input class="form-control txt-field" type="tel" name="phone" placeholder="Numero Telefono">
							    </div>
							    <div class="form-group row">
							        <div class="col-md-12">
							            <button type="reset" class="btn btn-default btn-lg btn-block text-center text-uppercase">Confimar</button>
							        </div>
							    </div>
							</form>
						</div>											
